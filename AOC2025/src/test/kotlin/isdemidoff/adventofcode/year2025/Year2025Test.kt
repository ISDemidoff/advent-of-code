...
class Year2025Test : FreeSpec({
    "Day 1: Secret Entrance" - {
        ...
        "Part one check" { builder.solvePart1() shouldBe 3 }
        "Part two check" { builder.solvePart2() shouldBe 6 }
    }

    "Day 2: Gift Shop" - {
        val builder = day2.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 1227775554 }
        "Part two check" { builder.solvePart2() shouldBe 4174379265 }
    }

    "Day 3: Lobby" - {
        val builder = day3.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 357 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 4: Printing Department" - {
        val builder = day4.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 13 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }
    ...
    "Day 6: Trash Compactor" - {
        ...
        "Part one check" { builder.solvePart1() shouldBe 4277556 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 7: Laboratories" - {
        val builder = day7.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 21 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 8: Playground" - {
        val builder = day8.input { sampleFile() }
        "Part one check" { builder.solvePart1(10) shouldBe 40 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 9: Movie Theater" - {
        val builder = day9.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 50 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 10: Factory" - {
        val builder = day10.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 7 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 11: Reactor" - {
        val builder = day11.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 5 }
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }

    "Day 12: Christmas Tree Farm" - {
        val builder = day12.input { sampleFile() }
        "Part one check" { builder.solvePart1() shouldBe 3 } // Lol actually not
        "!Part two check" { builder.solvePart2() shouldBe TODO() }
    }
})