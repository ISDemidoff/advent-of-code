...
import isdemidoff.SimpleDeprecatedSolution
...
) : SimpleDeprecatedSolution<Map<Reindeer, Int>, List<Reindeer>>(
    input = reindeer,
...
class Day14SolutionBuilder(
    ...
    private val raceConditions: RaceConditions = RaceConditions.DISTANCE_TRAVELLED,
) : SimpleDeprecatedSolutionBuilder<Map<Reindeer, Int>, List<Reindeer>>(
    inputsDir = day14Path,
